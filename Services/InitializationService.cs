...
namespace BacklogManager.Services
{
    public class InitializationService
    {
        ...
        private void InitializeUsers()
        {
            ...
            // NOTE: Les utilisateurs ne sont plus créés automatiquement
            // Ils seront ajoutés manuellement par l'administrateur via l'interface
            // ou lors de leur première connexion avec authentification Windows
        }
